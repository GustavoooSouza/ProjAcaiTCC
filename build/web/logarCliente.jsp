...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                <div class="navbar-header">
                    <a class="navbar-brand" href="${pageContext.request.contextPath}/index.html">Açai+Sabores</a>
                </div>
        ...
        <br />
        <form action="LogarCliente" method="POST" align="center">
            <input type="text" placeholder="Login" name="cpf">
            <br /><br />
