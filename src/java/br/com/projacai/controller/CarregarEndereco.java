 ...
 * @author Usuário
 */
@WebServlet(name = "CarregarEndereco", urlPatterns = {"/CarregarEndereco"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
                ...
                try {
                    ...
                    request.setAttribute("endereco", dao.carregar(idEndereco));
                    request.getRequestDispatcher("ListarEndereco").forward(request, response);
                } catch (Exception ex) {
                    System.out.println("Problemas ao carregar endereco - servlet - erro : "+ex.getMessage());
                    ex.printStackTrace();
                }
    }
